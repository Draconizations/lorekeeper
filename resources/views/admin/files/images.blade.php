        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="d-flex flex-column flex-sm-row">
                    <div class="mr-2" style="width: 200px;"><img src="{{ asset('images/' . $image['filename'] . '?v=' . Storage::disk(getDisk('images'))->lastModified('images/' . $image['filename'])) }}" class="mw-100" alt="Site image: {{ $image['name'] }}" /></div>
                    <div style="width: 100%;">
